...
Primary systems need to implement and integrate only few transactions to connect to the Swiss Electronic Patient Record (EPR), mainly for Patient and Document Mangement as well as for Authentication and Authorisation.
