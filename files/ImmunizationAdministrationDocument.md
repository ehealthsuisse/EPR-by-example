...
* *extension:* The extension defining the recorder (administering the immunization) of the immunization entry (line . to .).
* *status:* The status of the immunization - binding: *[ImmunizationStatusCodes](http://hl7.org/fhir/R4/valueset-immunization-status.html)* (line . to .)
* *vaccineCode:* The vaccine code defining the vaccine given to the patient - different bindings possible:
